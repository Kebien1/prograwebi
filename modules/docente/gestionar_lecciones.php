...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($titulo && $url) {
        if ($accion == 'crear') {
            ...
            $mensaje = "<div class='alert alert-success'>Lección creada.</div>";
...
<div class="container mt-4">
    <div class="d-flex align-items-center mb-4">
        <a href="mis_cursos.php" class="btn btn-outline-secondary me-3 rounded-circle"><i class="bi bi-arrow-left"></i></a>
        <div>
            <h4 class="mb-0">Contenido del Curso</h4>
            <small class="text-muted"><?php echo htmlspecialchars($curso['titulo']); ?></small>
        </div>
    </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><?php echo $leccion_a_editar ? 'Editar' : 'Nueva Lección'; ?></h5>
                </div>
                <div class="card-body">
                    <form method="post">
                        ...
                        <?php if($leccion_a_editar): ?>
                            <a href="gestionar_lecciones.php?id=<?php echo $id_curso; ?>" class="btn btn-secondary w-100 mt-2">Cancelar</a>
                        <?php endif; ?>
                    </form>
                </div>
            </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body p-0">
                    <table class="table table-hover mb-0">
                        <thead class="bg-light"><tr><th class="ps-4">Lección</th><th class="text-end pe-4">Acciones</th></tr></thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-4">
                                    <a href="gestionar_lecciones.php?id=<?php echo $id_curso; ?>&editar=<?php echo $l['id']; ?>" class="btn btn-sm btn-primary"><i class="bi bi-pencil"></i></a>
                                    <a href="gestionar_lecciones.php?id=<?php echo $id_curso; ?>&borrar=<?php echo $l['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Borrar?');"><i class="bi bi-trash"></i></a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
